...
public:                                                                                                                \
	...
	{                                                                                                                  \
		...
		NTT_OBJECT_TRACE("Registered object type: %s with ID: %u", #className, s_IDInfo.id.value);                     \
		return RESULT_SUCCESS;                                                                                         \
	}                                                                                                                  \
	static Result UnregisterType()                                                                                     \
	{                                                                                                                  \
		NTT_ASSERT_RESULT_SUCCESS(IDSystem::FreeID(s_IDInfo.id));                                                      \
		s_IDInfo.pParentInfo = nullptr;                                                                                \
		NTT_OBJECT_TRACE("Unregistered object type: %s with ID: %u", #className, s_IDInfo.id.value);                   \
		return RESULT_SUCCESS;                                                                                         \
	}                                                                                                                  \
	NTT_OBJECT_TYPE_CHECK_METHOD(className)
