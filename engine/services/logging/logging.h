...
#define NTT_RESOURCE_TRACE(format, ...) NTT_LOG_TRACE(LOGGING_TYPE_RESOURCE, format, ##__VA_ARGS__)
#define NTT_RESOURCE_DEBUG(format, ...) NTT_LOG_DEBUG(LOGGING_TYPE_RESOURCE, format, ##__VA_ARGS__)
#define NTT_RESOURCE_INFO(format, ...)	NTT_LOG_INFO(LOGGING_TYPE_RESOURCE, format, ##__VA_ARGS__)
#define NTT_RESOURCE_WARN(format, ...)	NTT_LOG_WARN(LOGGING_TYPE_RESOURCE, format, ##__VA_ARGS__)
#define NTT_RESOURCE_ERROR(format, ...) NTT_LOG_ERROR(LOGGING_TYPE_RESOURCE, format, ##__VA_ARGS__)
#define NTT_RESOURCE_FATAL(format, ...) NTT_LOG_FATAL(LOGGING_TYPE_RESOURCE, format, ##__VA_ARGS__)
